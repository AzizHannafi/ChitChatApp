...
public class Constants {
    ...
    public static final String KEY_DATE_OF_BIRTH = "dateOfBrirth";
    public static final String KEY_PHONE_NUMBER = "phoneNumber";
    public static final String KEY_PASSWORD = "password";
    public static final String KEY_IS_SIGNED_IN = "isSignedIn";
    public static final String KEY_USER_ID = "userId";
    public static final String KEY_PREFERNCE_NAME = "chitChatAppPreference";
    public static final String KEY_FCM_TOKEN = "fcmToken";
    public static final String KEY_USER = "user";
    public static final String KEY_COLLECTION_CAHT = "chat";
    ...
    public static final String KEY_RECIEVRE_NAME = "recieverName";

    public static final String KEY_RECIEVRE_ID = "recieveriD";
